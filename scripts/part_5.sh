...
for part in 0.2 0.4 0.6 0.8;do
    ...
    for number in 1;do
        ...
        for((i=0;i<${#seed[*]};i++)); do
            ...
            python idea/domainPretrain.py --epochs=${number} --model_input_path=./model/chinese_macbert_base --reasonable=True --cuda=${cuda}  --part=${part} --seed=${seed[i]}
