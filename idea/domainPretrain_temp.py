...
def main(arg):
    ...
    if arg.train_type  == 'question_type_random':
        ...
        f = open('./data/finalCleanQuestionGeneration/bridge/question_type_random_pretuning_train_data_6_new1.pkl', 'rb')
...
if __name__ == '__main__':
    ...
    parse.add_argument('--reasonable', type=bool, default=False)
